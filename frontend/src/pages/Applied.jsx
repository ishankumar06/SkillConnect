...
//   useEffect(() => {
//     // Debug log for applications & jobs
//     console.log("DEBUG: applications from context:", applications);
//     console.log("DEBUG: jobs from context:", jobs);

//     if (jobs.length === 0) return;

//     // Merge jobs with applied applications:
//     const merged = applications
//       .map(({ jobId, status, appliedAt }) => {
//         // Debug log for jobId matching
//         console.log("DEBUG: Checking jobId", jobId);
//         const job = jobs.find((j) => String(j.id) === String(jobId));
//         if (!job) {
//           console.log("DEBUG: Job not found for jobId:", jobId);
//           return null;
//         }
//         return {
//           ...job,
...
//     // Debug log for merged applied jobs
...
//         You have not applied to any jobs yet.<br />
...
//       {appliedJobDetails.map(({ id, title, status, appliedAt, company, location }) => (
