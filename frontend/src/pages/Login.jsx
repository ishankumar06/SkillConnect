...
//   const { allUsers, addOrUpdateUser } = useUsers();  // Updated from `users` to `allUsers`

//   const handleLogin = (e) => {
//     e.preventDefault();

//     if (email && password) {
//       // Find user from allUsers state by email (case-insensitive)
//       const user = Object.values(allUsers || {}).find(
//         (u) => u.email?.trim().toLowerCase() === email.trim().toLowerCase()
//       );

//       if (user) {
//         // Password check can be added here if passwords are stored securely
//         login(user._id);
//         setProfile(user);
